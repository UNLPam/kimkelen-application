...
class BaseCourseSubjectTeacherFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'situation_r_id'    => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'situation_r_id'    => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
