...
(
	...
	`course_subject_id` INTEGER  NOT NULL COMMENT 'Referencia a la cursada de una materia',
	`situation_r_id` INTEGER  NOT NULL,
...
DROP TABLE IF EXISTS `letter_mark`;
...
DROP TABLE IF EXISTS `letter_mark_average`;


CREATE TABLE `letter_mark_average`
(
	`id` INTEGER  NOT NULL AUTO_INCREMENT,
	`letter_mark_1` VARCHAR(255)  NOT NULL,
	`letter_mark_2` VARCHAR(255)  NOT NULL,
	`letter_mark_3` VARCHAR(255)  NOT NULL,
	`letter_mark_4` VARCHAR(255)  NOT NULL,
	`letter_mark_5` VARCHAR(255)  NOT NULL,
	`letter_mark_average` VARCHAR(255)  NOT NULL,
	PRIMARY KEY (`id`)
...
(
	...
	`numerical_mark` INTEGER default 1 COMMENT 'Esta configuracion define si la nota es numerica 1 o con letras 0',
	PRIMARY KEY (`id`)
