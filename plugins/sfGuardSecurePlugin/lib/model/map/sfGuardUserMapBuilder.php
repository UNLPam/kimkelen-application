...
class sfGuardUserMapBuilder implements MapBuilder {
	 ...
	 */
	const CLASS_NAME = 'plugins.sfGuardSecurePlugin.lib.model.map.sfGuardUserMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('CHANGE_PASSWORD_AT', 'ChangePasswordAt', 'TIMESTAMP', false, null);

		$tMap->addColumn('MUST_CHANGE_PASSWORD', 'MustChangePassword', 'BOOLEAN', true, null);
