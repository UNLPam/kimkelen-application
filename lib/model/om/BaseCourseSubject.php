...
/**
 * Base class that represents a row from the 'course_subject' table.
 *
 ...
 */
abstract class BaseCourseSubject extends BaseObject  implements Persistent {


  const PEER = 'CourseSubjectPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        CourseSubjectPeer
	 */
	...
	/**
	 * Initializes internal state of BaseCourseSubject object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     CourseSubject The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = CourseSubjectPeer::ID;
		}
	...
	public function setCourseId($v)
	{
		...
		if ($this->course_id !== $v) {
			$this->course_id = $v;
			$this->modifiedColumns[] = CourseSubjectPeer::COURSE_ID;
		}
	...
	public function setCareerSubjectSchoolYearId($v)
	{
		...
		if ($this->career_subject_school_year_id !== $v) {
			...
			$this->modifiedColumns[] = CourseSubjectPeer::CAREER_SUBJECT_SCHOOL_YEAR_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = CourseSubjectPeer::NUM_COLUMNS - CourseSubjectPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating CourseSubject object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = CourseSubjectPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseCourseSubject:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			CourseSubjectPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseCourseSubject:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseCourseSubject:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseCourseSubject:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			CourseSubjectPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = CourseSubjectPeer::doInsert($this, $con);
					...
					$affectedRows += CourseSubjectPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = CourseSubjectPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = CourseSubjectPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = CourseSubjectPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CourseSubjectPeer::ID)) $criteria->add(CourseSubjectPeer::ID, $this->id);
		if ($this->isColumnModified(CourseSubjectPeer::COURSE_ID)) $criteria->add(CourseSubjectPeer::COURSE_ID, $this->course_id);
		if ($this->isColumnModified(CourseSubjectPeer::CAREER_SUBJECT_SCHOOL_YEAR_ID)) $criteria->add(CourseSubjectPeer::CAREER_SUBJECT_SCHOOL_YEAR_ID, $this->career_subject_school_year_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(CourseSubjectPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of CourseSubject (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     CourseSubject Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     CourseSubjectPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new CourseSubjectPeer();
		}
		return self::$peer;
	}
	...
	public function getCourse(PropelPDO $con = null)
	{
		if ($this->aCourse === null && ($this->course_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aCourse->addCourseSubjects($this);
			 */
		}
		return $this->aCourse;
	}
	...
	public function getCareerSubjectSchoolYear(PropelPDO $con = null)
	{
		if ($this->aCareerSubjectSchoolYear === null && ($this->career_subject_school_year_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aCareerSubjectSchoolYear->addCourseSubjects($this);
			 */
		}
	 ...
	 * related CourseSubjectConfigurations from storage. If this CourseSubject is new, it will return
		...
		if ($this->collCourseSubjectConfigurations === null) {
			if ($this->isNew()) {
			   $this->collCourseSubjectConfigurations = array();
				...
				$criteria->add(CourseSubjectConfigurationPeer::COURSE_SUBJECT_ID, $this->id);
	 ...
	 * Otherwise if this CourseSubject is new, it will return
	 * an empty collection; or if this CourseSubject has previously
	 * been saved, it will retrieve related CourseSubjectConfigurations from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in CourseSubject.
	 */
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this CourseSubject has previously been saved, it will retrieve
	 * related CourseSubjectTeachers from storage. If this CourseSubject is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collCourseSubjectTeachers === null) {
			if ($this->isNew()) {
			   $this->collCourseSubjectTeachers = array();
				...
				$criteria->add(CourseSubjectTeacherPeer::COURSE_SUBJECT_ID, $this->id);
	 ...
	 * actually need in CourseSubject.
	 */
	public function getCourseSubjectTeachersJoinTeacher($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(CourseSubjectPeer::DATABASE_NAME);
		}
		...
		if ($this->collCourseSubjectTeachers === null) {
			if ($this->isNew()) {
				...
				$this->collCourseSubjectTeachers = CourseSubjectTeacherPeer::doSelectJoinTeacher($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this CourseSubject has previously been saved, it will retrieve
	 * related CourseSubjectDays from storage. If this CourseSubject is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collCourseSubjectDays === null) {
			if ($this->isNew()) {
			   $this->collCourseSubjectDays = array();
				...
				$criteria->add(CourseSubjectDayPeer::COURSE_SUBJECT_ID, $this->id);
	 ...
	 * actually need in CourseSubject.
	 */
	public function getCourseSubjectDaysJoinClassroom($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(CourseSubjectPeer::DATABASE_NAME);
		}
		...
		if ($this->collCourseSubjectDays === null) {
			if ($this->isNew()) {
				...
				$this->collCourseSubjectDays = CourseSubjectDayPeer::doSelectJoinClassroom($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this CourseSubject has previously been saved, it will retrieve
	 * related StudentApprovedCourseSubjects from storage. If this CourseSubject is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collStudentApprovedCourseSubjects === null) {
			if ($this->isNew()) {
			   $this->collStudentApprovedCourseSubjects = array();
				...
				$criteria->add(StudentApprovedCourseSubjectPeer::COURSE_SUBJECT_ID, $this->id);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this CourseSubject has previously been saved, it will retrieve
	 * related CourseSubjectStudentPathways from storage. If this CourseSubject is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collCourseSubjectStudentPathways === null) {
			if ($this->isNew()) {
			   $this->collCourseSubjectStudentPathways = array();
				...
				$criteria->add(CourseSubjectStudentPathwayPeer::COURSE_SUBJECT_ID, $this->id);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this CourseSubject has previously been saved, it will retrieve
	 * related StudentAttendances from storage. If this CourseSubject is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collStudentAttendances === null) {
			if ($this->isNew()) {
			   $this->collStudentAttendances = array();
				...
				$criteria->add(StudentAttendancePeer::COURSE_SUBJECT_ID, $this->id);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this CourseSubject has previously been saved, it will retrieve
	 * related StudentReincorporations from storage. If this CourseSubject is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collStudentReincorporations === null) {
			if ($this->isNew()) {
			   $this->collStudentReincorporations = array();
				...
				$criteria->add(StudentReincorporationPeer::COURSE_SUBJECT_ID, $this->id);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this CourseSubject has previously been saved, it will retrieve
	 * related StudentFrees from storage. If this CourseSubject is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collStudentFrees === null) {
			if ($this->isNew()) {
			   $this->collStudentFrees = array();
				...
				$criteria->add(StudentFreePeer::COURSE_SUBJECT_ID, $this->id);
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseCourseSubject:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseCourseSubject::%s', $method));
    }
