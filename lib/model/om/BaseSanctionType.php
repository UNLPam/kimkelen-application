...
/**
 * Base class that represents a row from the 'sanction_type' table.
 *
 ...
 */
abstract class BaseSanctionType extends BaseObject  implements Persistent {


  const PEER = 'SanctionTypePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        SanctionTypePeer
	 */
	...
	/**
	 * The value for the considered_in_report_card field.
	 * Note: this column has a database default value of: true
	 * @var        boolean
	 */
	protected $considered_in_report_card;
	...
	/**
	 * Initializes internal state of BaseSanctionType object.
	 * @see        applyDefaults()
	 */
	...
	{
		$this->considered_in_report_card = true;
	}
	...
	/**
	 * Get the [considered_in_report_card] column value.
	 * 
	 * @return     boolean
	 */
	public function getConsideredInReportCard()
	{
		return $this->considered_in_report_card;
	}
	 ...
	 * @return     SanctionType The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = SanctionTypePeer::ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = SanctionTypePeer::NAME;
		}
	...
	/**
	 * Set the value of [considered_in_report_card] column.
	 * 
	 * @param      boolean $v new value
	 * @return     SanctionType The current object (for fluent API support)
	 */
	public function setConsideredInReportCard($v)
	{
		if ($v !== null) {
			$v = (boolean) $v;
		}

		if ($this->considered_in_report_card !== $v || $v === true) {
			$this->considered_in_report_card = $v;
			$this->modifiedColumns[] = SanctionTypePeer::CONSIDERED_IN_REPORT_CARD;
		}

		return $this;
	} // setConsideredInReportCard()
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(SanctionTypePeer::CONSIDERED_IN_REPORT_CARD))) {
				return false;
			}

			if ($this->considered_in_report_card !== true) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->considered_in_report_card = ($row[$startcol + 2] !== null) ? (boolean) $row[$startcol + 2] : null;
			$this->resetModified();
			...
			return $startcol + 3; // 3 = SanctionTypePeer::NUM_COLUMNS - SanctionTypePeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating SanctionType object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = SanctionTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseSanctionType:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			SanctionTypePeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseSanctionType:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseSanctionType:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseSanctionType:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			SanctionTypePeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = SanctionTypePeer::doInsert($this, $con);
					...
					$affectedRows += SanctionTypePeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = SanctionTypePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = SanctionTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 1:
				...
				break;
			case 2:
				return $this->getConsideredInReportCard();
				break;
			default:
				return null;
				break;
	...
	{
		$keys = SanctionTypePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getName(),
			$keys[2] => $this->getConsideredInReportCard(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 1:
				...
				break;
			case 2:
				$this->setConsideredInReportCard($value);
				break;
		} // switch()
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setConsideredInReportCard($arr[$keys[2]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SanctionTypePeer::ID)) $criteria->add(SanctionTypePeer::ID, $this->id);
		if ($this->isColumnModified(SanctionTypePeer::NAME)) $criteria->add(SanctionTypePeer::NAME, $this->name);
		if ($this->isColumnModified(SanctionTypePeer::CONSIDERED_IN_REPORT_CARD)) $criteria->add(SanctionTypePeer::CONSIDERED_IN_REPORT_CARD, $this->considered_in_report_card);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(SanctionTypePeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of SanctionType (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setConsideredInReportCard($this->considered_in_report_card);
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     SanctionType Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     SanctionTypePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new SanctionTypePeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this SanctionType has previously been saved, it will retrieve
	 * related StudentDisciplinarySanctions from storage. If this SanctionType is new, it will return
		...
		if ($this->collStudentDisciplinarySanctions === null) {
			if ($this->isNew()) {
			   $this->collStudentDisciplinarySanctions = array();
				...
				$criteria->add(StudentDisciplinarySanctionPeer::SANCTION_TYPE_ID, $this->id);
	 ...
	 * Otherwise if this SanctionType is new, it will return
	 * an empty collection; or if this SanctionType has previously
	 * been saved, it will retrieve related StudentDisciplinarySanctions from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in SanctionType.
	 */
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseSanctionType:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseSanctionType::%s', $method));
    }
