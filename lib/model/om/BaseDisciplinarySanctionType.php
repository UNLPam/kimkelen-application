...
/**
 * Base class that represents a row from the 'disciplinary_sanction_type' table.
 *
 ...
 */
abstract class BaseDisciplinarySanctionType extends BaseObject  implements Persistent {


  const PEER = 'DisciplinarySanctionTypePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        DisciplinarySanctionTypePeer
	 */
	...
	/**
	 * Initializes internal state of BaseDisciplinarySanctionType object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     DisciplinarySanctionType The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = DisciplinarySanctionTypePeer::ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = DisciplinarySanctionTypePeer::NAME;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = DisciplinarySanctionTypePeer::NUM_COLUMNS - DisciplinarySanctionTypePeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating DisciplinarySanctionType object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = DisciplinarySanctionTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseDisciplinarySanctionType:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			DisciplinarySanctionTypePeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseDisciplinarySanctionType:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseDisciplinarySanctionType:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseDisciplinarySanctionType:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			DisciplinarySanctionTypePeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = DisciplinarySanctionTypePeer::doInsert($this, $con);
					...
					$affectedRows += DisciplinarySanctionTypePeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = DisciplinarySanctionTypePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = DisciplinarySanctionTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = DisciplinarySanctionTypePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getName(),
		);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(DisciplinarySanctionTypePeer::ID)) $criteria->add(DisciplinarySanctionTypePeer::ID, $this->id);
		if ($this->isColumnModified(DisciplinarySanctionTypePeer::NAME)) $criteria->add(DisciplinarySanctionTypePeer::NAME, $this->name);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(DisciplinarySanctionTypePeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of DisciplinarySanctionType (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     DisciplinarySanctionType Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     DisciplinarySanctionTypePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new DisciplinarySanctionTypePeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this DisciplinarySanctionType has previously been saved, it will retrieve
	 * related StudentDisciplinarySanctions from storage. If this DisciplinarySanctionType is new, it will return
		...
		if ($this->collStudentDisciplinarySanctions === null) {
			if ($this->isNew()) {
			   $this->collStudentDisciplinarySanctions = array();
				...
				$criteria->add(StudentDisciplinarySanctionPeer::DISCIPLINARY_SANCTION_TYPE_ID, $this->id);
	...
	public function addStudentDisciplinarySanction(StudentDisciplinarySanction $l)
	{
		...
		if (!in_array($l, $this->collStudentDisciplinarySanctions, true)) { // only add it if the **same** object is not already associated
			...
			$l->setDisciplinarySanctionType($this);
		}
	}
	 ...
	 * Otherwise if this DisciplinarySanctionType is new, it will return
	 * an empty collection; or if this DisciplinarySanctionType has previously
	 * been saved, it will retrieve related StudentDisciplinarySanctions from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in DisciplinarySanctionType.
	 */
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseDisciplinarySanctionType:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseDisciplinarySanctionType::%s', $method));
    }
