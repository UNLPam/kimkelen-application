  ...
  const PEER = 'sfGuardUserProfilePeer';
	...
	public function setIdentificationType($v)
	{
		...
		if ($this->identification_type !== $v) {
			...
			$this->modifiedColumns[] = sfGuardUserProfilePeer::IDENTIFICATION_TYPE;
		}
	...
	public function setIdentificationNumber($v)
	{
		...
		if ($this->identification_number !== $v) {
			...
			$this->modifiedColumns[] = sfGuardUserProfilePeer::IDENTIFICATION_NUMBER;
		}
	...
	public function setObservations($v)
	{
		...
		if ($this->observations !== $v) {
			$this->observations = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::OBSERVATIONS;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->identification_type = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->identification_number = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->email = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->phone = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->observations = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->resetModified();
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[4] => $this->getIdentificationType(),
			$keys[5] => $this->getIdentificationNumber(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setIdentificationType($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setIdentificationNumber($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setEmail($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setPhone($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setObservations($arr[$keys[8]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(sfGuardUserProfilePeer::IDENTIFICATION_TYPE)) $criteria->add(sfGuardUserProfilePeer::IDENTIFICATION_TYPE, $this->identification_type);
		if ($this->isColumnModified(sfGuardUserProfilePeer::IDENTIFICATION_NUMBER)) $criteria->add(sfGuardUserProfilePeer::IDENTIFICATION_NUMBER, $this->identification_number);
		...
		if ($this->isColumnModified(sfGuardUserProfilePeer::OBSERVATIONS)) $criteria->add(sfGuardUserProfilePeer::OBSERVATIONS, $this->observations);
