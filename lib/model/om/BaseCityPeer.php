...
abstract class BaseCityPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'ZipCode', 'Name', 'StateId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'zipCode', 'name', 'stateId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::ZIP_CODE, self::NAME, self::STATE_ID, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'zip_code', 'name', 'state_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ZipCode' => 1, 'Name' => 2, 'StateId' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'zipCode' => 1, 'name' => 2, 'stateId' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::ZIP_CODE => 1, self::NAME => 2, self::STATE_ID => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'zip_code' => 1, 'name' => 2, 'state_id' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CityPeer::ZIP_CODE);
	...
	public static function doCountJoinState(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(CityPeer::STATE_ID,), array(StatePeer::ID,), $join_behavior);
    ...
    foreach (sfMixer::getCallables('BaseCityPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseCityPeer', $c, $con);
		...
		$c->addJoin(array(CityPeer::STATE_ID,), array(StatePeer::ID,), $join_behavior);
