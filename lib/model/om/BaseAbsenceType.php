...
/**
 * Base class that represents a row from the 'absence_type' table.
 *
 * 
 *
 ...
 */
abstract class BaseAbsenceType extends BaseObject  implements Persistent {


  const PEER = 'AbsenceTypePeer';
	...
	/**
	 * Initializes internal state of BaseAbsenceType object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     AbsenceType The current object (for fluent API support)
	 */
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = AbsenceTypePeer::NAME;
		}
	...
	public function setValue($v)
	{
		...
		if ($this->value !== $v || $v === '0') {
			$this->value = $v;
			$this->modifiedColumns[] = AbsenceTypePeer::VALUE;
		}
	...
	public function setMethod($v)
	{
		...
		if ($this->method !== $v || $v === 0) {
			$this->method = $v;
			$this->modifiedColumns[] = AbsenceTypePeer::METHOD;
		}
	...
	public function setOrder($v)
	{
		...
		if ($this->order !== $v) {
			$this->order = $v;
			$this->modifiedColumns[] = AbsenceTypePeer::ORDER;
		}
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = AbsenceTypePeer::DESCRIPTION;
		}
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = AbsenceTypePeer::ID;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(AbsenceTypePeer::VALUE,AbsenceTypePeer::METHOD))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->method = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			...
			return $startcol + 6; // 6 = AbsenceTypePeer::NUM_COLUMNS - AbsenceTypePeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating AbsenceType object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = AbsenceTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseAbsenceType:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			AbsenceTypePeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseAbsenceType:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseAbsenceType:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseAbsenceType:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			AbsenceTypePeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = AbsenceTypePeer::doInsert($this, $con);
					...
					$affectedRows += AbsenceTypePeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = AbsenceTypePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = AbsenceTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = AbsenceTypePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getName(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AbsenceTypePeer::NAME)) $criteria->add(AbsenceTypePeer::NAME, $this->name);
		if ($this->isColumnModified(AbsenceTypePeer::VALUE)) $criteria->add(AbsenceTypePeer::VALUE, $this->value);
		if ($this->isColumnModified(AbsenceTypePeer::METHOD)) $criteria->add(AbsenceTypePeer::METHOD, $this->method);
		if ($this->isColumnModified(AbsenceTypePeer::ORDER)) $criteria->add(AbsenceTypePeer::ORDER, $this->order);
		if ($this->isColumnModified(AbsenceTypePeer::DESCRIPTION)) $criteria->add(AbsenceTypePeer::DESCRIPTION, $this->description);
		if ($this->isColumnModified(AbsenceTypePeer::ID)) $criteria->add(AbsenceTypePeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(AbsenceTypePeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of AbsenceType (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     AbsenceType Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     AbsenceTypePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new AbsenceTypePeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this AbsenceType has previously been saved, it will retrieve
	 * related StudentAttendances from storage. If this AbsenceType is new, it will return
		...
		if ($this->collStudentAttendances === null) {
			if ($this->isNew()) {
			   $this->collStudentAttendances = array();
				...
				$criteria->add(StudentAttendancePeer::ABSENCE_TYPE_ID, $this->id);
	 ...
	 * Otherwise if this AbsenceType is new, it will return
	 * an empty collection; or if this AbsenceType has previously
	 * been saved, it will retrieve related StudentAttendances from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in AbsenceType.
	 */
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseAbsenceType:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseAbsenceType::%s', $method));
    }
