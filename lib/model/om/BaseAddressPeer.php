...
abstract class BaseAddressPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'StateId', 'CityId', 'Street', 'Number', 'Floor', 'Flat', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'stateId', 'cityId', 'street', 'number', 'floor', 'flat', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::STATE_ID, self::CITY_ID, self::STREET, self::NUMBER, self::FLOOR, self::FLAT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'state_id', 'city_id', 'street', 'number', 'floor', 'flat', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'StateId' => 1, 'CityId' => 2, 'Street' => 3, 'Number' => 4, 'Floor' => 5, 'Flat' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'stateId' => 1, 'cityId' => 2, 'street' => 3, 'number' => 4, 'floor' => 5, 'flat' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::STATE_ID => 1, self::CITY_ID => 2, self::STREET => 3, self::NUMBER => 4, self::FLOOR => 5, self::FLAT => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'state_id' => 1, 'city_id' => 2, 'street' => 3, 'number' => 4, 'floor' => 5, 'flat' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new AddressMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(AddressPeer::STATE_ID);

		$criteria->addSelectColumn(AddressPeer::CITY_ID);

		$criteria->addSelectColumn(AddressPeer::STREET);

		$criteria->addSelectColumn(AddressPeer::NUMBER);

		$criteria->addSelectColumn(AddressPeer::FLOOR);
    ...
    foreach (sfMixer::getCallables('BaseAddressPeer:doCount:doCount') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseAddressPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseAddressPeer', $criteria, $con);
    }
	...
	public static function doCountJoinState(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(AddressPeer::STATE_ID,), array(StatePeer::ID,), $join_behavior);
	...
	public static function doCountJoinCity(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(AddressPeer::CITY_ID,), array(CityPeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of Address objects pre-filled with their State objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    foreach (sfMixer::getCallables('BaseAddressPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseAddressPeer', $c, $con);
    }
		...
		$c->addJoin(array(AddressPeer::STATE_ID,), array(StatePeer::ID,), $join_behavior);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Address) to $obj2 (State)
	...
	public static function doSelectJoinCity(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(AddressPeer::CITY_ID,), array(CityPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
    ...
    foreach (sfMixer::getCallables('BaseAddressPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseAddressPeer', $c, $con);
    }
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Address) to the collection in $obj2 (State)
				$obj2->addAddress($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Address) to the collection in $obj3 (City)
	...
	/**
	 * Selects a collection of Address objects pre-filled with all related objects except State.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    foreach (sfMixer::getCallables('BaseAddressPeer:doSelectJoinAllExcept:doSelectJoinAllExcept') as $callable)
    {
      call_user_func($callable, 'BaseAddressPeer', $c, $con);
    }
	...
	/**
	 * Selects a collection of Address objects pre-filled with all related objects except City.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
...
//
// NOTE: This static code cannot call methods on the AddressPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the AddressPeer class:
//
// Propel::getDatabaseMap(AddressPeer::DATABASE_NAME)->addTableBuilder(AddressPeer::TABLE_NAME, AddressPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseAddressPeer::DATABASE_NAME)->addTableBuilder(BaseAddressPeer::TABLE_NAME, BaseAddressPeer::getMapBuilder());
