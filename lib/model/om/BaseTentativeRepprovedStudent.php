...
/**
 * Base class that represents a row from the 'tentative_repproved_student' table.
 *
 ...
 */
abstract class BaseTentativeRepprovedStudent extends BaseObject  implements Persistent {


  const PEER = 'TentativeRepprovedStudentPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        TentativeRepprovedStudentPeer
	 */
	...
	/**
	 * Initializes internal state of BaseTentativeRepprovedStudent object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     TentativeRepprovedStudent The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = TentativeRepprovedStudentPeer::ID;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = TentativeRepprovedStudentPeer::CREATED_AT;
			}
	...
	public function setStudentCareerSchoolYearId($v)
	{
		...
		if ($this->student_career_school_year_id !== $v) {
			...
			$this->modifiedColumns[] = TentativeRepprovedStudentPeer::STUDENT_CAREER_SCHOOL_YEAR_ID;
		}
	...
	public function setIsDeleted($v)
	{
		...
		if ($this->is_deleted !== $v || $v === false) {
			$this->is_deleted = $v;
			$this->modifiedColumns[] = TentativeRepprovedStudentPeer::IS_DELETED;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(TentativeRepprovedStudentPeer::IS_DELETED))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = TentativeRepprovedStudentPeer::NUM_COLUMNS - TentativeRepprovedStudentPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating TentativeRepprovedStudent object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = TentativeRepprovedStudentPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseTentativeRepprovedStudent:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			TentativeRepprovedStudentPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseTentativeRepprovedStudent:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseTentativeRepprovedStudent:save:pre') as $callable)
    {
    ...
    if ($this->isNew() && !$this->isColumnModified(TentativeRepprovedStudentPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseTentativeRepprovedStudent:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			TentativeRepprovedStudentPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = TentativeRepprovedStudentPeer::doInsert($this, $con);
					...
					$affectedRows += TentativeRepprovedStudentPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = TentativeRepprovedStudentPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = TentativeRepprovedStudentPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = TentativeRepprovedStudentPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TentativeRepprovedStudentPeer::ID)) $criteria->add(TentativeRepprovedStudentPeer::ID, $this->id);
		if ($this->isColumnModified(TentativeRepprovedStudentPeer::CREATED_AT)) $criteria->add(TentativeRepprovedStudentPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(TentativeRepprovedStudentPeer::STUDENT_CAREER_SCHOOL_YEAR_ID)) $criteria->add(TentativeRepprovedStudentPeer::STUDENT_CAREER_SCHOOL_YEAR_ID, $this->student_career_school_year_id);
		if ($this->isColumnModified(TentativeRepprovedStudentPeer::IS_DELETED)) $criteria->add(TentativeRepprovedStudentPeer::IS_DELETED, $this->is_deleted);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(TentativeRepprovedStudentPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of TentativeRepprovedStudent (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     TentativeRepprovedStudent Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     TentativeRepprovedStudentPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new TentativeRepprovedStudentPeer();
		}
		return self::$peer;
	}
	...
	public function setStudentCareerSchoolYear(StudentCareerSchoolYear $v = null)
	{
		...
		if ($v !== null) {
			$v->addTentativeRepprovedStudent($this);
		}
	...
	public function getStudentCareerSchoolYear(PropelPDO $con = null)
	{
		if ($this->aStudentCareerSchoolYear === null && ($this->student_career_school_year_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aStudentCareerSchoolYear->addTentativeRepprovedStudents($this);
			 */
		}
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseTentativeRepprovedStudent:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseTentativeRepprovedStudent::%s', $method));
    }
