...
*/
    //field civil status widget and validator
    $this->setWidget('civil_status', new sfWidgetFormSelect(array(
      'choices'  => BaseCustomOptionsHolder::getInstance('CivilStatusType')->getOptions()
    )));
