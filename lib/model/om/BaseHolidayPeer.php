 ...
 *
 * Cada tupla representa un día feriado
 *
...
abstract class BaseHolidayPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Holiday';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Day', 'Description', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'day', 'description', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::DAY, self::DESCRIPTION, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'day', 'description', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Day' => 1, 'Description' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'day' => 1, 'description' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::DAY => 1, self::DESCRIPTION => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'day' => 1, 'description' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new HolidayMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(HolidayPeer::DAY);

		$criteria->addSelectColumn(HolidayPeer::DESCRIPTION);
    ...
    foreach (sfMixer::getCallables('BaseHolidayPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseHolidayPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseHolidayPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseHolidayPeer', $criteria, $con);
    }
	 ...
	 *
	 * @param      Holiday $value A Holiday object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Holiday $obj, $key = null)
	{
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseHolidayPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseHolidayPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseHolidayPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseHolidayPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseHolidayPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseHolidayPeer', $values, $con);
      if (false !== $ret)
      {
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(HolidayPeer::ID, $criteria->remove(HolidayPeer::ID), $comparison);
    ...
    foreach (sfMixer::getCallables('BaseHolidayPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseHolidayPeer', $values, $con, $ret);
    }
	...
	public static function doValidate(Holiday $obj, $cols = null)
	{
		...
		$res =  BasePeer::doValidate(HolidayPeer::DATABASE_NAME, HolidayPeer::TABLE_NAME, $columns);
    if ($res !== true) {
        foreach ($res as $failed) {
            $col = HolidayPeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
        }
    }
...
//
// NOTE: This static code cannot call methods on the HolidayPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the HolidayPeer class:
//
// Propel::getDatabaseMap(HolidayPeer::DATABASE_NAME)->addTableBuilder(HolidayPeer::TABLE_NAME, HolidayPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseHolidayPeer::DATABASE_NAME)->addTableBuilder(BaseHolidayPeer::TABLE_NAME, BaseHolidayPeer::getMapBuilder());
