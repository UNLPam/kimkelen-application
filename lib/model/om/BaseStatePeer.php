...
abstract class BaseStatePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'CountryId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'countryId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::COUNTRY_ID, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'country_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'CountryId' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'countryId' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::COUNTRY_ID => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'country_id' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
    ...
    foreach (sfMixer::getCallables('BaseStatePeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseStatePeer', $c, $con);
		...
		$c->addJoin(array(StatePeer::COUNTRY_ID,), array(CountryPeer::ID,), $join_behavior);
