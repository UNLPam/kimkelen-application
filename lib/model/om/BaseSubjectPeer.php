...
abstract class BaseSubjectPeer {
	...
	/** the column name for the FANTASY_NAME field */
	const FANTASY_NAME = 'subject.FANTASY_NAME';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'CreatedAt', 'Name', 'FantasyName', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'createdAt', 'name', 'fantasyName', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::CREATED_AT, self::NAME, self::FANTASY_NAME, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'created_at', 'name', 'fantasy_name', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'CreatedAt' => 1, 'Name' => 2, 'FantasyName' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'createdAt' => 1, 'name' => 2, 'fantasyName' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::CREATED_AT => 1, self::NAME => 2, self::FANTASY_NAME => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'created_at' => 1, 'name' => 2, 'fantasy_name' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new SubjectMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(SubjectPeer::FANTASY_NAME);
    ...
    foreach (sfMixer::getCallables('BaseSubjectPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseSubjectPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseSubjectPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseSubjectPeer', $criteria, $con);
    }
  ...
  {
    return array(array('name', 'fantasy_name'));
  }
	/**
	...
	{
		return SubjectPeer::CLASS_DEFAULT;
	}
    ...
    foreach (sfMixer::getCallables('BaseSubjectPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseSubjectPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseSubjectPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseSubjectPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseSubjectPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseSubjectPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseSubjectPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseSubjectPeer', $values, $con, $ret);
    }
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof Subject) {
	...
	public static function doValidate(Subject $obj, $cols = null)
	{
		...
		$res =  BasePeer::doValidate(SubjectPeer::DATABASE_NAME, SubjectPeer::TABLE_NAME, $columns);
    if ($res !== true) {
        foreach ($res as $failed) {
            $col = SubjectPeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
        }
    }
...
//
// NOTE: This static code cannot call methods on the SubjectPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the SubjectPeer class:
//
// Propel::getDatabaseMap(SubjectPeer::DATABASE_NAME)->addTableBuilder(SubjectPeer::TABLE_NAME, SubjectPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseSubjectPeer::DATABASE_NAME)->addTableBuilder(BaseSubjectPeer::TABLE_NAME, BaseSubjectPeer::getMapBuilder());
