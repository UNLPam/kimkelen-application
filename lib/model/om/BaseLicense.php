...
abstract class BaseLicense extends BaseObject  implements Persistent {
  ...
  const PEER = 'LicensePeer';
	...
	public function setPersonId($v)
	{
		...
		if ($this->person_id !== $v) {
			$this->person_id = $v;
			$this->modifiedColumns[] = LicensePeer::PERSON_ID;
		}
	...
	public function setLicenseTypeId($v)
	{
		...
		if ($this->license_type_id !== $v) {
			...
			$this->modifiedColumns[] = LicensePeer::LICENSE_TYPE_ID;
		}

		if ($this->aLicenseType !== null && $this->aLicenseType->getId() !== $v) {
			$this->aLicenseType = null;
		}
	...
	public function setDateFrom($v)
	{
		...
		if ( $this->date_from !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = LicensePeer::DATE_FROM;
			}
	...
	public function setDateTo($v)
	{
		...
		if ( $this->date_to !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = LicensePeer::DATE_TO;
			}
		} // if either are not null
	...
	public function setObservation($v)
	{
		...
		if ($this->observation !== $v) {
			$this->observation = $v;
			$this->modifiedColumns[] = LicensePeer::OBSERVATION;
		}
	...
	public function setIsActive($v)
	{
		...
		if ($this->is_active !== $v || $v === true) {
			$this->is_active = $v;
			$this->modifiedColumns[] = LicensePeer::IS_ACTIVE;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(LicensePeer::IS_ACTIVE))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->license_type_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			...
			return $startcol + 7; // 7 = LicensePeer::NUM_COLUMNS - LicensePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function ensureConsistency()
	{
		...
		if ($this->aLicenseType !== null && $this->license_type_id !== $this->aLicenseType->getId()) {
			$this->aLicenseType = null;
		}
	} // ensureConsistency
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aLicenseType !== null) {
				if ($this->aLicenseType->isModified() || $this->aLicenseType->isNew()) {
					$affectedRows += $this->aLicenseType->save($con);
				}
				$this->setLicenseType($this->aLicenseType);
			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->aLicenseType !== null) {
				if (!$this->aLicenseType->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aLicenseType->getValidationFailures());
				}
			}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setLicenseTypeId($arr[$keys[1]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LicensePeer::PERSON_ID)) $criteria->add(LicensePeer::PERSON_ID, $this->person_id);
		if ($this->isColumnModified(LicensePeer::LICENSE_TYPE_ID)) $criteria->add(LicensePeer::LICENSE_TYPE_ID, $this->license_type_id);
		if ($this->isColumnModified(LicensePeer::DATE_FROM)) $criteria->add(LicensePeer::DATE_FROM, $this->date_from);
		if ($this->isColumnModified(LicensePeer::DATE_TO)) $criteria->add(LicensePeer::DATE_TO, $this->date_to);
		if ($this->isColumnModified(LicensePeer::OBSERVATION)) $criteria->add(LicensePeer::OBSERVATION, $this->observation);
		if ($this->isColumnModified(LicensePeer::IS_ACTIVE)) $criteria->add(LicensePeer::IS_ACTIVE, $this->is_active);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setLicenseTypeId($this->license_type_id);
	...
	/**
	 * Declares an association between this object and a LicenseType object.
	 *
	 * @param      LicenseType $v
	 * @return     License The current object (for fluent API support)
	 * @throws     PropelException
	 */
	public function setLicenseType(LicenseType $v = null)
	{
		if ($v === null) {
			$this->setLicenseTypeId(NULL);
		} else {
			$this->setLicenseTypeId($v->getId());
		}

		$this->aLicenseType = $v;

		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the LicenseType object, it will not be re-added.
		if ($v !== null) {
			$v->addLicense($this);
		}
	...
	/**
	 * Get the associated LicenseType object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     LicenseType The associated LicenseType object.
	 * @throws     PropelException
	 */
	public function getLicenseType(PropelPDO $con = null)
	{
		if ($this->aLicenseType === null && ($this->license_type_id !== null)) {
			$c = new Criteria(LicenseTypePeer::DATABASE_NAME);
			$c->add(LicenseTypePeer::ID, $this->license_type_id);
			$this->aLicenseType = LicenseTypePeer::doSelectOne($c, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aLicenseType->addLicenses($this);
			 */
		}
		return $this->aLicenseType;
	}
